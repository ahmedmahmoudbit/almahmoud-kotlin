...
import com.almahmoudApp.al_mahmoudapp.feature.quran.data.local.projection.AyahPageProjection
import com.almahmoudApp.al_mahmoudapp.feature.quran.data.local.projection.PageHizbProjection
import com.almahmoudApp.al_mahmoudapp.feature.quran.data.local.projection.PageJuzProjection
...
interface MushafDao {
    ...
    @Query("SELECT no_of_pages FROM mushafs WHERE mushaf_id = :mushafId LIMIT 1")
    suspend fun getPageCount(mushafId: Int): Int?
}
